...
export function ShipmentTrackingNumber({ className, number }: ShipmentTrackingNumberProps) {
      ...
      <Popover open={isCopied}>
        ...
        >
          <div
            ...
            role="status"
          >
            <CheckCircle2 aria-hidden="true" className="mt-0.5 size-4 text-emerald-600" />
            <span>
              <span className="block font-medium">Номер скопирован</span>
              <span className="mt-0.5 block text-muted-foreground">{number}</span>
            </span>
          </div>
        </PopoverContent>
      </Popover>
