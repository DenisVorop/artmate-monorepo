...
export const seoPages = {
  ...
  product: {
    ...
    description:
      "Подробная информация об\u00a0альбоме Artmate: раскраска по\u00a0номерам A4, 25 иллюстраций, бумага 190 г/м², фото, характеристики и\u00a0маркетплейсы.",
    canonical: routes.catalog,
  ...
  partners: {
    title: "Партнёрская программа Artmate для креаторов",
    description:
      "Партнёрская программа Artmate: персональные промокоды, настройка выгоды между вознаграждением и скидкой, статистика продаж по каждому коду.",
    canonical: routes.partners,
    keywords: [
      "common",
      "партнёрская программа Artmate",
      "сотрудничество с Artmate",
      "промокод для креатора",
      "партнёрская программа для художников",
      "амбассадор Artmate",
    ],
    ogAlt: "Партнёрская программа Artmate для креаторов",
  },
  account: {
