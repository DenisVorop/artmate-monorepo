...
export const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          `Напишите нам как можно быстрее на ${companyDetails.supportEmail} и укажите номер заказа. Если заказ еще не передан в доставку, мы поможем внести изменения или отменить его.`,
      },
      {
    ...
    items: [
      {
        ...
        answer:
          `Напишите на ${companyDetails.supportEmail} с темой «Возврат» и номером заказа. Товар должен быть не использован и сохранен в первоначальном состоянии.`,
      },
      {
      ...
      },
      {
        ...
        answer:
          `Сфотографируйте проблему и напишите нам на ${companyDetails.supportEmail}. Мы разберемся и предложим замену или возврат.`,
      },
    ],
  },
  {
