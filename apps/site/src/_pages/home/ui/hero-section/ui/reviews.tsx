    ...
    <div className="flex flex-wrap items-center gap-6">
      <AvatarGroup className="*:data-[slot=avatar]:ring-white">
        {reviewAvatars.map((image) => (
          <Avatar key={image.src} className="size-9 border-2 border-white ring-1 ring-stone-100">
            <AvatarImage src={image.src} alt="" />
      ...
      <div className="flex items-center gap-1.5">
        ...
        <Badge
          variant="secondary"
          className="h-5 rounded-full bg-amber-50 px-2 text-sm font-medium text-stone-700"
        >
          4.9
        </Badge>
